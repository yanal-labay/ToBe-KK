...
// server/uploads/jobs/ — created on boot if missing. Gitignored; these are
...
/**
 * Multer middleware for the optional job-posting photo upload. Used as
 ...
 * error-handling middleware in job.routes.js, which turns them into a
...
/**
 * Best-effort delete of a previously-uploaded job photo from disk. Called
 * when a job's photo is replaced on update, or when the job itself is
 * deleted.
 *
 * @param {string|null|undefined} photoUrl - the job's stored `photoUrl`
 *   (e.g. "/uploads/jobs/12345-678.png"), or null.
 */
