...
router.post("/", requireAuth, upload.single("photo"), toCloudinary, createScholarship);
router.patch("/:id", requireAuth, upload.single("photo"), toCloudinary, updateScholarship);
